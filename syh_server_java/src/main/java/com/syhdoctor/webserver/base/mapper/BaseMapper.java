package com.syhdoctor.webserver.base.mapper;
...
public abstract class BaseMapper {
     ...
     * @return long
     */
    protected long update(@NotNull String sql, Object... args) {
     ...
     * @return long
     */
    protected long update(@NotNull String sql, List<Object> params) {
...
//    protected int[] batchUpdate(@NotNull String sql, List<Object> params) {
...
//    }
     ...
     * @return java.com.syhdoctor.webserver.api.util.List
     */
    protected List<Map<String, Object>> queryForList(@NotNull String sql) {
     ...
     * @return java.com.syhdoctor.webserver.api.util.List
     */
    protected List<Map<String, Object>> queryForList(@NotNull String sql, Object... args) {
        if (args != null && args.length > 0) {
     ...
     * @return java.com.syhdoctor.webserver.api.util.List
     */
    protected List<Map<String, Object>> queryForList(@NotNull String sql, List<Object> params) {
     ...
     * @return java.com.syhdoctor.webserver.api.util.List
     */
    protected List<Map<String, Object>> queryForList(@NotNull String sql, @NotNull Map<String, Object> params) {
        log.info("mapper query sql > " + sql);
        log.info("mapper query params > " + params.toString());
     ...
     * @return java.com.syhdoctor.webserver.api.util.Map
     */
    protected Map<String, Object> queryForMap(@NotNull String sql, Object... args) {
        if (args != null && args.length > 0) {
     ...
     * @return java.com.syhdoctor.webserver.api.util.Map
     */
    protected Map<String, Object> queryForMap(@NotNull String sql, List<Object> params) {
     ...
     * @return java.com.syhdoctor.webserver.api.util.List
     */
    protected List<Map<String, Object>> query(@NotNull String sql, List<Object> params, RowMapper<Map<String, Object>> rowMapper) {
        if (params == null) {
