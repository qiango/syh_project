...
public class WechatPayConfig {
    ...
    private String syhAppAppid;
    @Value("${wechat.syhapp.mchid}")
    private String syhAppMchId;
    @Value("${wechat.syhapp.mchkey}")
    private String syhAppMchKey;
    @Value("${wechat.syhapp.keypath}")
    private String syhAppKeyPath;
    ...
    public IPayService wechatAppPayImpl() {
        return new WechatAppPayServiceImpl(wxPayService(syhAppAppid, syhAppMchId, syhAppMchKey, BASEFILEPATH + FileUtil.setFileName(FileUtil.FILE_STATIC_PATH, syhAppKeyPath)));
    }
}
