package com.syhdoctor.webserver.controller.webapp.webapi.microclass;
...
@Api(description = "/Web/MicroClass 健康大学")
@RestController
@RequestMapping("/Web/MicroClass")
public class WebMicroClassController extends BaseController {
    @Autowired
