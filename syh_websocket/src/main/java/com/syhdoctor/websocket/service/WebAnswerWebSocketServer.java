...
@ServerEndpoint(value = "/websocket/{orderid}/{userno}")
@Component
public class WebAnswerWebSocketServer {
    static Logger log = LoggerFactory.getLogger(WebAnswerWebSocketServer.class);
    ...
    public static void setApplicationContext(ApplicationContext applicationContext) {
        WebAnswerWebSocketServer.applicationContext = applicationContext;
    }
...
//    private static CopyOnWriteArraySet<WebSocketServer> webSocketSet = new CopyOnWriteArraySet<WebSocketServer>();
    ...
    public static ConcurrentHashMap<String, WebAnswerWebSocketServer> webSocketSet = new ConcurrentHashMap<String, WebAnswerWebSocketServer>();
...
//        }
    ...
    public static void sendToUser(String message) {
        ...
        List<String> list = WebAnswerWebSocketServer.groupUserno.get(sendUserno);
        if (list != null) {
            for (String userno : list) {
                new WebAnswerSleepThread(userno, sendMessage).start();
            }
        }
    }
...
//    }
    ...
    public static synchronized void addOnlineCount() {
        WebAnswerWebSocketServer.onlineCount++;
    }
...
class WebAnswerSleepThread extends Thread {
    ...
    public WebAnswerSleepThread(String sendUserno, String sendMessage) {
    ...
    @Override
    public void run() {
        if (WebAnswerWebSocketServer.webSocketSet.get(sendUserno) == null) {
        ...
        try {
            if (WebAnswerWebSocketServer.webSocketSet.get(sendUserno) != null) {
                WebAnswerWebSocketServer.webSocketSet.get(sendUserno).sendMessage(sendMessage);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
