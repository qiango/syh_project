 ...
 */
package com.syhdoctor.common.utils.ffmpeg;
...
public class DefaultFFMPEGLocator extends FFMPEGLocator {
     ...
     * temp file.
     */
    public DefaultFFMPEGLocator(String base) {
        // Windows?
        boolean isWindows;
...
//        }
        ...
        File exe = new File(base + FileUtil.setFileName(FileUtil.FILE_STATIC_PATH, "ffmpeg/ffmpeg" + suffix));
//        if (!exe.exists()) {
//            FileUtil.copyFile(FileUtil.getStaticPath() + "ffmpeg/ffmpeg" + suffix, exe);
//        }
        // pthreadGC2.dll
		/*if (isWindows) {
