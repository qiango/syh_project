...
public class AliWebPayServiceImpl implements IPayService {
    ...
    public PayBean pay(String orderNo, BigDecimal totalFee, String user, String des, String ip, String notify_url, String return_url) {
        log.info("AliWebPayServiceImpl->pay orderno:" + orderNo + "totalFee:" + totalFee + "user:" + user + "des:" + des + "ip:" + ip + "notify_url:" + notify_url + "return_url:" + return_url);
        ...
        try {
            ...
            result.setForm(client.pageExecute(alipay_request).getBody());
